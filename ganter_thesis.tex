...
%TODO 1 - finish chapter 4
%TODO 1 - write chapter 5
%TODO 1 - write appendix
...
where $\lambda[n] = N F_0[n] $.  The ``$)$'' denotes that (\ref{eq:harmonic-to-stft_relate}) is a DTFT.  For derivation of (\ref{eq:harmonic-to-stft_relate}) refer to appendix~\ref{section:stft_vs_harmonic_derivation}.
