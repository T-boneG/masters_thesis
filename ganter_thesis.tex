...
Feature selection is an important aspect of processing and there appears to be a tradeoff between selection of most important features and consistency of stimuli.  In coherent processing there is additional knowledge about the signal from the pitch estimator.  This could be used to improve consistency of feature selection.
...
There is a large body of research on transient detection and explicit encoding \cite{bonada2000automatic} \cite{levine1998sines} \cite{masri1996improved} \cite{masri1996computer}.  This approach could be used to circumvent the tradeoff between steady-state envelope extraction and transient smearing.
...
\subsection{Improved pitch estimation}
